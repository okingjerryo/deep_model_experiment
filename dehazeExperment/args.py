...
parser.add_argument("--output_dir", type=str, required=False, help="where to put output files")
...
# dataset options
parser.add_argument("--path_to_record", default="/home/uryuo/db/ntire/tfRecord/",
                    help="the path navgate to tfrecord dir")
parser.add_argument("--img_haze_gt_path", default="/home/uryuo/db/ntire/image/haze_1/indoor/trainHaze/*.jpg",
                    help="path to ground true images")
parser.add_argument("--img_haze_noise_path", default='/home/uryuo/db/ntire/image/haze_1/indoor/trainHaze/*.jpg',
                    help="path to noise path")
parser.add_argument("--img_haze_vaild_path", default='/home/uryuo/db/ntire/image/haze_1/indoor/validateHaze/*.png',
                    help="path to vaild path")
parser.add_argument("--record_train_name", default="haze_1_train.tfrecord", help="train tfrecord file name")
parser.add_argument("--record_vaild_name", default="haze_1_vaild.tfrecord", help="vaild tfrecord file name")
a = parser.parse_args()
# 数据集相关
